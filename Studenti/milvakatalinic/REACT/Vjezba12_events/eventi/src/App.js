...
nameChangeHandler = (event) => {
  ...
  const newUsers = [...users]; //spred operator(tri tockice),ova linija nam radi kopiju users niza u newUsers
  newUsers[0].name = event.target.value; //value je svojstvo input elementa
  this.setState({users: newUsers});
